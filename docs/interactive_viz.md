...
[Orion Search](https://www.orion-search.org/)
...
[Exploring Fashion MNIST](https://observablehq.com/@stwind/exploring-fashion-mnist/)
...
[ESM Metagenomic Atlas](https://esmatlas.com/explore)
...
![UMAP interactive visualization with Nomic Atlas](https://assets.nomicatlas.com/mnist-training-embeddings-umap-short.gif)
<!-- width: 600 -->
...
## Nomic Atlas Examples

- [nomic_atlas_umap_of_text_embeddings](nomic_atlas_umap_of_text_embeddings)
- [nomic_atlas_visualizing_mnist_training_dynamics](nomic_atlas_visualizing_mnist_training_dynamics)
