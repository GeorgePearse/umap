...
To follow along with this example, see the MNIST_Landmarks notebook on the [GitHub repository](https://github.com/lmcinnes/umap/tree/master/notebooks/)
