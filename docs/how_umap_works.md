...
called [*simplices*](https://en.wikipedia.org/wiki/Simplex).
...
![Low dimensional simplices](images/simplices.png)
...
[*simplicial sets*](https://en.wikipedia.org/wiki/Simplicial_set)
...
![Test data set of a noisy sine wave](images/how_umap_works_raw_data.png)
...
![A basic open cover of the test data](images/how_umap_works_open_cover.png)
...
![A simplicial complex built from the test data](images/how_umap_works_basic_graph.png)
...
eigenmaps <https://en.wikipedia.org/wiki/Nonlinear_dimensionality_reduction#Laplacian_eigenmaps>`__ and [Diffusion maps](https://en.wikipedia.org/wiki/Nonlinear_dimensionality_reduction#Diffusion_maps). Force directed layouts are
also an option, and provide algorithms closer to [MDS](https://en.wikipedia.org/wiki/Multidimensional_scaling) or `Sammon
...
![Open balls over uniformly\_distributed\_data](images/how_umap_works_uniform_distribution_cover.png)
...
![Open balls of radius one with a locally varying metric](images/how_umap_works_local_metric_open_cover.png)
...
![Fuzzy open balls of radius one with a locally varying metric](images/how_umap_works_fuzzy_open_cover.png)
...
and our [paper](https://arxiv.org/abs/1802.03426). It will have to
...
![Local connectivity and fuzzy open sets](images/how_umap_works_umap_open_cover.png)
...
![Edges with incompatible weights](images/how_umap_works_raw_graph.png)
...
![Graph with combined edge weights](images/how_umap_works_umap_graph.png)
