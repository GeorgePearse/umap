...
[Clustering with UMAP: Why and How Connectivity Matters](https://arxiv.org/abs/2108.05525)
...
[this paper](https://arxiv.org/abs/2108.05525) . However, one pitfall of using a
...
to this [Github repo](https://github.com/adalmia96/umap-mnn). Will be adding this soon as a
